    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          id={menuId}
          role="menu"
          className="absolute right-0 top-full mt-1.5 w-48 rounded-xl border border-border/80 bg-popover/95 backdrop-blur-2xl shadow-xl py-1 z-50 overflow-hidden"
          onClick={event => {

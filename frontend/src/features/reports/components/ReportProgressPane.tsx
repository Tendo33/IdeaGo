    ...
    <div className="max-w-xl mx-auto space-y-3 mt-4">
      {preview.appType && (
        <motion.div
          ...
          className="rounded-none border border-2 border-border bg-card  shadow-[4px_4px_0px_0px_var(--border)] p-5"
        >
      ...
      {preview.sourcePreviews.length > 0 && (
        <motion.div
          ...
          className="rounded-none border border-2 border-border bg-card  shadow-[4px_4px_0px_0px_var(--border)] p-5 mt-4"
        >

      ...
      <table className="w-full text-sm border-collapse">
        ...
        <tbody>
          ...
          <tr className="border-b border-2 border-border/30">
            ...
            {competitors.map(competitor => (
              <td
                ...
                className="px-4 py-3 text-xs text-foreground leading-relaxed border-l border-2 border-border break-words min-w-[200px] whitespace-normal"
              >
          ...
          <tr className="border-b border-2 border-border/30">
            ...
            {competitors.map(competitor => (
              <td key={`${getCompetitorId(competitor)}-pricing`} className="px-4 py-3 text-xs text-foreground font-medium border-l border-2 border-border">
                {competitor.pricing ?? '-'}
              </td>
            ))}
          </tr>

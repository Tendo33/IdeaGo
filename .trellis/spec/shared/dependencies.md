...
Use this when adding or updating dependencies on the `main` branch.
...
| Persistence | local file cache and SQLite checkpoints |
| Observability | `loguru`, metrics, Sentry when configured |
...
- Do not add Supabase, Stripe, LinuxDo, account, quota, profile, or admin
  runtime requirements to `main`.
